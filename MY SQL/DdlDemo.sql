...
INSERT INTO staff(NAME,email,city,doj) VALUES('Harry','hary@training.com','Noida','2017-06-01');
...
INSERT INTO staff(NAME,email,city,doj) VALUES('Manoj','manu@training','Mumbai','2012-12-15');
INSERT INTO staff(NAME,email,city,doj) VALUES('Mahesh','mahi@training','Chennai',CURRENT_DATE);
...
INSERT INTO staff(salary) VALUES(12000);

ALTER TABLE staff ADD gender CHAR(10);
DESC staff;
...
(200,'Raj','raj@test.com','Delhi','2018-12-07',15000,'Male');
...
INSERT INTO staff VALUES
(202,'Sangamesh','sangaj@test.com','Vijaypur','2018-12-07',9000,'Male');
...
INSERT INTO staff VALUES
(202,'Raj','raj@test.com','Delhi','2018-12-07',15000,'Male',999999);

INSERT INTO staff VALUES
(203,'Raj','raj@test.com','Delhi','2018-12-07',15000,'Male');
...
INSERT INTO staff VALUES
(205,'Monty','monty@test.com','Chennai','2012-12-07',19000,'Male',999999);
...
INSERT INTO staff VALUES
(206,'VVV','VVV@test.com','Home','2018-12-07',null,'Male');
...
-- foreign key error
INSERT INTO employees VALUES(1002,'Mary','John','2012-12-12',2,'Electrician',CURRENT_DATE, 105);
INSERT INTO employees VALUES(1004,'Mary','John','2012-12-12',2,'Electrician',CURRENT_DATE, 103);
INSERT INTO employees VALUES(1003,'Jk','John','2012-12-12',2,'Electrician',CURRENT_DATE, 103);
SELECT * FROM employees;
...
INSERT INTO employees1 VALUES(1001,'Raj','Mark','2012-12-12',2,
'Employees Salary amd client payments',CURRENT_DATE ,101);

INSERT INTO employees1 VALUES(1002,'Mary','John','2012-12-12',2,
'Electrician',CURRENT_DATE ,103);

INSERT INTO employees1 VALUES(1003,'jk','John','2012-12-12',2,
'Electrician',CURRENT_DATE ,103);

SELECT * FROM employees1;
SELECT * FROM departments1;

DELETE FROM departments1 WHERE d_id=103; -- deletes because of cascade
