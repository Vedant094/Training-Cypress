...
00136853,'Vedant Works','Raturi','Vedant','8755099365'
,'Rishikeh','Dehradun','Rishikesh','Uttarakhand','249201','India',44343,500000);
SELECT * FROM customersbackup2025 WHERE city='Rishikesh';
